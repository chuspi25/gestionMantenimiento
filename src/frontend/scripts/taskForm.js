import { validateTaskForm } from './types.js';
...
export class TaskForm {
    ...
    setupEventListeners() {
        ...
        const toolsInput = document.getElementById('task-tools-input');
    ...
    setupRealTimeValidation() {
        ...
        fields.forEach(fieldName => {
            const field = document.getElementById(`task-${fieldName}`);
            if (field) {
     ...
     */
    addTool() {
        const input = document.getElementById('task-tools-input');
