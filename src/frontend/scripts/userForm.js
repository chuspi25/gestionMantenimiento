        ...
        if (this.mode === 'edit') {
            ...
            changePasswordToggle?.addEventListener('change', () => {
                if (passwordFields) {
                    ...
                    const confirmNewPasswordField = document.getElementById('user-confirm-new-password');
    ...
    getFormData() {
        ...
        if (this.mode === 'create') {
            ...
            if (changePasswordToggle?.checked) {
                data.password = formData.get('newPassword');
                data.confirmPassword = formData.get('confirmNewPassword');
            }
        }
        return data;
    }
