...
export class ProfileManager {
    ...
    private activeTab: 'profile' | 'password' = 'profile';
     ...
     */
    private renderPasswordTab(): string {
     ...
     */
    private renderNotAuthenticated(): void {
        this.container.innerHTML = `
    ...
    private setupEventListeners(): void {
        ...
        tabButtons.forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                const tab = target.dataset.tab as 'profile' | 'password';
                if (tab) {
                    this.switchTab(tab);
                }
            });
    ...
    private setupRealTimeValidation(): void {
        ...
        const profileNameField = document.getElementById('profile-name') as HTMLInputElement;
        const profileEmailField = document.getElementById('profile-email') as HTMLInputElement;
     ...
     */
    private switchTab(tab: 'profile' | 'password'): void {
        this.activeTab = tab;
        ...
        const profileContent = document.querySelector('.profile-tab-content') as HTMLElement;
        const passwordContent = document.querySelector('.password-tab-content') as HTMLElement;
     ...
     */
    private getProfileFormData(): ProfileData {
        const nameField = document.getElementById('profile-name') as HTMLInputElement;
     ...
     */
    private getPasswordFormData(): ProfileData {
        ...
        const confirmPasswordField = document.getElementById('confirm-new-password') as HTMLInputElement;
     ...
     */
    private validateProfileData(data: ProfileData): string[] {
        const errors: string[] = [];
     ...
     */
    private validatePasswordData(data: ProfileData): string[] {
        const errors: string[] = [];
     ...
     */
    private validateProfileField(fieldName: string): boolean {
        const field = document.getElementById(`profile-${fieldName}`) as HTMLInputElement;
     ...
     * Guardar perfil
     */
    private async saveProfile(data: ProfileData): Promise<User> {
     ...
     * Cambiar contraseña
     */
    private async changePassword(data: ProfileData): Promise<void> {
     ...
     */
    private setProfileLoading(loading: boolean): void {
        const submitButton = document.getElementById('save-profile-button') as HTMLButtonElement;
        ...
        if (submitButton) {
            ...
            if (buttonText) buttonText.style.display = loading ? 'none' : 'block';
            if (buttonSpinner) buttonSpinner.style.display = loading ? 'flex' : 'none';
        }
    }
     ...
     */
    private setPasswordLoading(loading: boolean): void {
        const submitButton = document.getElementById('change-password-button') as HTMLButtonElement;
        const buttonText = submitButton?.querySelector('.button-text') as HTMLElement;
        const buttonSpinner = submitButton?.querySelector('.button-spinner') as HTMLElement;
