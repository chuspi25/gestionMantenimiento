...
function setupEventListeners() {
    ...
    window.addEventListener('error-occurred', handleGlobalError);
...
function togglePasswordVisibility() {
    ...
    const icon = togglePasswordButton.querySelector('.toggle-password-icon');
 ...
 */
function updateMainContent(route) {
 ...
 */
function loadTasksContent(container, _user) {
    container.innerHTML = `
 ...
 */
function loadCreateTaskContent(container, _user) {
    container.innerHTML = `
        <div class="page-header">
 ...
 */
function loadUsersContent(container, _user) {
    container.innerHTML = `
 ...
 */
function loadCreateUserContent(container, _user) {
    container.innerHTML = `
 ...
 */
function loadReportsContent(container, _user) {
    container.innerHTML = `
 ...
 */
function loadSettingsContent(container, _user) {
    container.innerHTML = `
 ...
 * Inicializar el componente ReportingInterface
 */
function initializeReportingInterface() {
 ...
 */
function initializeUserForm(mode, user) {
 ...
 */
function showUserProfile(_user) {
    const userListContainer = document.getElementById('user-list-container');
 ...
 * Inicializar el componente TaskForm
 */
function initializeTaskForm(mode, task) {
